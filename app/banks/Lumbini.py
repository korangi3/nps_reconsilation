...
class LumbiniBank(Reconcile):
    ...
    def get_phase4_df(self):
        self.bank_statement_df = pd.read_excel(Banks_FILEPATH.LUMBINI_BANK_FILE,skiprows=1)
        self.soa_statement_df = pd.read_csv(SOA_FILEPATH.LUMBINI_SOA_FILE, encoding='latin-1')
